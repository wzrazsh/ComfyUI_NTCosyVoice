...
class NTCosyVoiceInstruct2Sampler:
    ...
    def main_func(self, audio, speed, text, prompt_text):
        ...
        try:
            for i, j in enumerate(self.cosyvoice.inference_instruct2(tts_text=text, prompt_text=prompt_text, prompt_speech_16k=prompt_speech_16k, stream=False, speed=speed)):
...
__all__ = ['NTCosyVoiceInstruct2Sampler']